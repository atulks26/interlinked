        ...
        <div>
            ...
            <div className="bg-gray-200 p-16 text-center">
                ...
                <p className="text-xl mb-6">
                    Collaborate, Coordinate, and Optimize Resources Across
                    Multiple Departments
                </p>
                <div>
                    <button className="bg-blue-600 text-white px-6 py-2 rounded-full mr-4">
                        <Link to="/register">Department Registration</Link>
                    </button>
            ...
            <div className="bg-gray-100 p-16">
                ...
                <p className="text-center mb-6">
                    Explore workshops and seminars to enhance your skills and
                    knowledge.
                </p>
