    ...
    <div className="max-w-6xl mx-auto p-10 sm:p-16 bg-gray-50 rounded-2xl shadow-2xl my-12">
      ...
      {!isSubmitted ? (
        <form onSubmit={handleSubmit} className="space-y-16">
          ...
          {step === 3 && (
            <div className="p-10 bg-white rounded-xl shadow-md space-y-8">
              <h2 className="text-2xl font-semibold mb-8">Upload Documents</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  {formData.authorizationDoc && (
                    <div className="mt-5">
                      <img
                        src={URL.createObjectURL(formData.authorizationDoc)}
                ...
                <div>
                  ...
                  {formData.taxProof && (
                    <div className="mt-5">
                      <img
                        src={URL.createObjectURL(formData.taxProof)}
            ...
            <div className="p-10 bg-white rounded-xl shadow-md space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-gray-800">
                <div>
                  ...
                  <p><strong>Name:</strong> {formData.departmentName}</p>
                  <p><strong>Type:</strong> {formData.departmentType}</p>
                  <p><strong>Reg. Number:</strong> {formData.registrationNumber}</p>
                ...
                <div>
                  ...
                  <p><strong>Person:</strong> {formData.contactPerson}</p>
                  <p><strong>Position:</strong> {formData.contactPosition}</p>
        ...
        <div className="flex flex-col items-center justify-center text-center py-20">
          <div className="bg-green-100 border-2 border-green-500 rounded-2xl p-10 shadow-lg max-w-lg">
            ...
            <p className="text-gray-700 text-lg">
              Thank you for registering your department.  
